...
The main office of the school of engineering will have its own subdivision that will consist a division, a department to analyze the time management system used around the world, and also to study the behaviour of the workers time management, and give at least 1 solution in every week, every 7 days on how to improve time management for the workers, with at least 10 special consultation room of a size at least 10 feet width x 10 feet length x 10 feet height in order to try to reach a perfect 10 score, the code of points set by the International Gymnastics Federation (FIG) for the Olympic Games.
