...
Every class in the school of engineering, every room in the library will install both analogue and digital clock that can count to nanosecond that working in silence, at least at the same level of the military standard submarine. The main office will be located in the center of the school of engineering, with a direct hit of sunlight from every direction, to place a visible horizontal sundial, also called a garden sundial, that stands 35 feet or equivalent to 11 metres above the main office and extends 62 feet or equivalent to 19 metres following the standard of The Whitehurst & Son sundial, every class in the school of engineering will start on how to read properly the sun clock, sundial, calendars, analogue and digital clock, and to always remember that `punctuality is the politeness of kings`, in order to raise them as a proper **Lord** and **Rex** in the future.

The main office of the school of engineering will have its own subdivision that will consist a division, a department to analyze the time management system used around the world, and also to study the behaviour of the workers time management, and give at least 1 solution in every week, every 7 days on how to improve time management for the workers, with a special consultation room of a size at least 10 feet width x 10 feet length x 10 feet height in order to try to reach a perfect 10 score, the code of points set by the International Gymnastics Federation (FIG) for the Olympic Games.
