...
The school must consist at least 5,000 students with their working area of at least 2 square meters, continuous flow of fresh air so if any pandemic occurs, if there is still a need to hold the class by the teachers, at least try to minimize the risk when everyone is in the school, at least 50 teachers with their working area following the Australian Army Slow Time that is 70 paces per minute with a 75cm pace, of at least 10,000 steps per day. To get continuous fresh air, the school will be built in the middle of a newly explored jungle, newly explored virgin territory, between at least 4 hills, where every hill, with the fresh air from those hills where in the middle of it will be built the school of engineering by the company, will first be tested using according to the prophet Ibrahim / Abraham / Avraham / Abram divine method mentioned in `2:260`.
